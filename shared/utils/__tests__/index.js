...
describe('Generic utilities', () => {
  test('requireUserLoginAndSupportedNetwork', () => {
    ...
    expect(requireUserLoginAndSupportedNetwork({ loading: false, viewUserByWallet: undefined }, { supported: false })).toBe(true);
    expect(requireUserLoginAndSupportedNetwork({ loading: false, viewUserByWallet: undefined }, { supported: true })).toBe(true);
  });
});
